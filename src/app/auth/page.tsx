      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent pr-12 transition-all duration-200"
              ...
              {error && (
                <SlideIn direction="down" delay={0}>
                  <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg animate-slide-in-right">
                    {error}
                  </div>
                </SlideIn>
              )}
              ...
              {/* Submit Button */}
              <FadeIn delay={isSignUp ? 500 : 300}>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02]"
                >
                  {isLoading ? (
        ...
        {isSignUp && (
          <SlideIn direction="up" delay={400}>
            <div className="mt-8 bg-blue-50 rounded-xl p-6 animate-slide-in-right">
        ...
        <FadeIn delay={isSignUp ? 500 : 300}>
          <div className="text-center mt-6 space-y-2">
            <div className="flex justify-center space-x-4 text-sm">
              <Link href="/widget" className="text-blue-600 hover:text-blue-800 transition-colors">
                Try Demo
              </Link>
